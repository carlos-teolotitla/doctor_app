...
<!--[if gt IE 9]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <div id="login-background">
            ...
            <img src="<c:url value='/resources/img/placeholders/headers/login_header.jpg'/>" alt="Login Background" class="animation-pulseSlow">
        </div>
        ...
        <div id="login-container" class="animation-fadeIn">
            ...
            <div class="login-title text-center">
                <h1><i class="gi gi-hospital"></i> <strong>Consultorio M&eacute;dico</strong><br><small>Favor de <strong>Acceder</strong> o <strong>Registrarse</strong></small> </h1>
            </div>
            <!-- END Login Title -->
            ...
            <div class="block push-bit">
                <!-- Login Form -->
                <form:form action="login" method="POST" id="form-login" class="form-horizontal form-bordered form-control-borderless" commandName="usuario">
                    <div class="form-group">
                        <div class="col-xs-12">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="gi gi-envelope"></i></span>
                                <input type="text" id="idUsuario" name="idUsuario" class="form-control input-lg" placeholder="ID Usuario">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-12">
                            <div class="input-group">
                                ...
                                <input type="password" id="password" name="password" class="form-control input-lg" placeholder="Contrase&ntilde;a">
                            </div>
                        </div>
                    </div>
                    <div class="form-group form-actions">
                        ...
                        <div class="col-xs-8 text-right">
                            <button type="submit" class="btn btn-sm btn-primary"><i class="fa fa-angle-right"></i>Acceder al sistema</button>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <footer class="text-muted text-center">
                <small><span id="year-copy"></span> &copy; <a href="http://goo.gl/TDOSuC" target="_blank">Raul Teolotitla Hurtado</a></small>
            </footer>
            <!-- END Footer -->
        </div>
        <!-- END Login Container -->
